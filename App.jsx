  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 text-slate-800 scroll-smooth">
      ...
      <header className="sticky top-0 z-50 backdrop-blur supports-[backdrop-filter]:bg-white/60 bg-white/50 border-b">
        <div className="w-full px-6 px-4 py-3 flex items-center justify-between">
        ...
        <AnimatePresence>
          {mobileOpen && (
            <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: "auto", opacity: 1 }} exit={{ height: 0, opacity: 0 }} className="md:hidden border-t bg-white/80 backdrop-blur">
              <div className="w-full px-6 px-4 py-2 grid">
                {navItems.map((n) => (
      ...
      <section id="home" className="relative overflow-hidden">
        ...
        <div className="w-full px-6 px-4 py-16 md:py-24 grid md:grid-cols-2 gap-10 items-center">
          <div>
      ...
      <section id="about" className="py-16 md:py-24">
        <div className="w-full px-6 px-4">
      ...
      <section id="contact" className="py-16 md:py-24 bg-white/70">
        <div className="w-full px-6 px-4 grid md:grid-cols-2 gap-8">
          <div>
      ...
      <footer className="border-t">
        <div className="w-full px-6 px-4 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
